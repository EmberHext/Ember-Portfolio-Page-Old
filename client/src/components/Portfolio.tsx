    ...
    <section id="portfolio" className="w-screen h-screen bg-black bg-opacity-75 text-white flex flex-col items-center justify-center">
      <div className="container mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-4 gap-8 max-w-8xl flex items-center">
        <div className="col-span-2 relative z-10 flex flex-col">
          ...
          <div className="text-center md:text-left bg-black relative z-10 text-white border-2 border-red-500 rounded-lg p-8 flex-grow h-[600px] overflow-auto">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 sm:p-2 md:p-4 lg:p-6 text-center">{currentProject.title}</h3>
            <p className="text-sm md:text-base lg:text-xl sm:p-2 md:p-4 lg:p-6">{currentProject.description}</p>
          </div>
        </div>
        <div className="col-span-2 relative z-10 flex items-center">
          <img src={currentProject.img} alt="Project preview" className="w-full h-full sm:max-w-md md:max-w-lg lg:max-w-3xl sm:max-h-64 md:max-h-96 lg:max-h-144 mx-auto rounded-md flex-grow" />
        </div>
      </div>
      <div className="container mx-auto px-4 md:px-8 mt-8 grid grid-cols-1 lg:grid-cols-5 gap-4">
